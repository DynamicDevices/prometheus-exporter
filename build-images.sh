#!/bin/bash
set -e
BLOCK_NAME="prometheus-node-exporter"
...
DOCKER_REPO=${1:-dynamicdevices}

build_and_push_image $DOCKER_REPO "raspberrypi4-64" "linux/amd64" "aarch64"

build_and_push_image $DOCKER_REPO "raspberrypi3" "linux/amd64" "armv7hf"
